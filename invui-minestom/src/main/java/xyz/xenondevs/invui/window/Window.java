...
public interface Window {
     ...
     */
    void setOutsideClickHandlers(@Nullable List<@NotNull Consumer<@NotNull InventoryPreClickEvent>> outsideClickHandlers);
     ...
     */
    void addOutsideClickHandler(@NotNull Consumer<@NotNull InventoryPreClickEvent> outsideClickHandler);
     ...
     */
    void removeOutsideClickHandler(@NotNull Consumer<@NotNull InventoryPreClickEvent> outsideClickHandler);
    ...
    interface Builder<W extends Window, S extends Builder<W, S>> extends Cloneable {
        ...
        @Contract("_ -> this")
        @NotNull
        S setOutsideClickHandlers(@NotNull List<@NotNull Consumer<@NotNull InventoryPreClickEvent>> outsideClickHandlers);
        ...
        @Contract("_ -> this")
        @NotNull
        S addOutsideClickHandler(@NotNull Consumer<@NotNull InventoryPreClickEvent> outsideClickHandler);
