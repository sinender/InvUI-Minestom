...
public class ReferencingInventory extends xyz.xenondevs.invui.inventory.Inventory {
    ...
    protected final @NotNull AbstractInventory inventory;
    protected final @NotNull Function<@NotNull AbstractInventory, @Nullable ItemStack @NotNull []> itemsGetter;
    protected final @NotNull BiFunction<@NotNull AbstractInventory, @NotNull Integer, @Nullable ItemStack> itemGetter;
    protected final @NotNull TriConsumer<@NotNull AbstractInventory, @NotNull Integer, @Nullable ItemStack> itemSetter;
    ...
    public ReferencingInventory(
        ...
        @NotNull Function<@NotNull AbstractInventory, @Nullable ItemStack @NotNull []> itemsGetter,
        @NotNull BiFunction<@NotNull AbstractInventory, @NotNull Integer, @Nullable ItemStack> itemGetter,
        @NotNull TriConsumer<@NotNull AbstractInventory, @NotNull Integer, @Nullable ItemStack> itemSetter
    ) {
    ...
    /**
     * Creates a new {@link ReferencingInventory} which references only the {@link Inventory#getItemStacks()}} () storage contents} of the specified {@link Inventory}.
     *
     * @param inventory The {@link Inventory} to reference.
     * @return The new {@link ReferencingInventory}.
     */
    public static @NotNull ReferencingInventory fromStorageContents(@NotNull AbstractInventory inventory) {
        return new ReferencingInventory(inventory, AbstractInventory::getItemStacks, AbstractInventory::getItemStack, AbstractInventory::setItemStack);
    }
     ...
     * @return The new {@link ReferencingInventory}.
     */
    public static @NotNull ReferencingInventory fromContents(@NotNull AbstractInventory inventory) {
        return new ReferencingInventory(inventory, AbstractInventory::getItemStacks, AbstractInventory::getItemStack, AbstractInventory::setItemStack);
    }
    
    /**
     * Creates a new {@link ReferencingInventory} with a reversed view of the {@link PlayerInventory PlayerInventory's}
     * {@link Inventory#getItemStacks()} ()} () storage contents}, where the last hotbar slot is the first slot and
    ...
    private static class ReversedPlayerContents extends ReferencingInventory {
        ...
        public ReversedPlayerContents(PlayerInventory inventory) {
            super(inventory, AbstractInventory::getItemStacks, AbstractInventory::getItemStack, AbstractInventory::setItemStack);
        }
