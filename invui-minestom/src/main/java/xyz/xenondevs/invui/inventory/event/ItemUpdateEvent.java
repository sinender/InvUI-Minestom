...
abstract class ItemUpdateEvent {
    ...
    public boolean isAdd() {
        if (newItemStack != null && previousItemStack != null && newItemStack.isSimilar(previousItemStack)) {
            return newItemStack.amount() > previousItemStack.amount();
    ...
    public int getRemovedAmount() {
        ...
        if (newItemStack == null) return previousItemStack.amount();
        else return previousItemStack.amount() - newItemStack.amount();
    }
    ...
    public int getAddedAmount() {
        ...
        if (previousItemStack == null) return newItemStack.amount();
        else return newItemStack.amount() - previousItemStack.amount();
    }
